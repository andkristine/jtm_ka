...
public class TrafficManagementSystem {
	...
	public static void addTransport(int i) {
		...
		transports = new Transport[i]; //parraksta jau uztaisito arrayu, neveido jaunu
	}
	...
	public static void setVehicle(Transport transport, int i) {
		...
		transports[i] = transport; //updeito esosho funkciju. AR SET VIENMER JAUPDEITO IEKSEJIE
	}
