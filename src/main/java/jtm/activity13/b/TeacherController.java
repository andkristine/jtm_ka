...
public class TeacherController {
	...
	public Teacher findTeacher(@RequestParam Integer id) {
		...
		Teacher teacher = manager.findTeacher(id);
	...
	public List<Teacher> findTeacher(@RequestParam String firstName, @RequestParam String lastName) {
		 ...
		 */
		List<Teacher> teacherList = manager.findTeacher(firstName, lastName);
		//List<Teacher> teacherList = new ArrayList<>();
		//	teacherList = manager.findTeacher(firstName, lastName);
	...
	public StatusResponse insertTeacher(@RequestParam(required = false) Integer id, @RequestParam String firstName,
		...
		boolean res = manager.insertTeacher(firstName, lastName);
		
		if (id == null) {
			res = manager.insertTeacher(firstName, lastName);
			response = new StatusResponse(true, "Success");
		} else {
			res = manager.insertTeacher(teacher);
			response = new StatusResponse(false, "Failure");
		}
